...
<div class="crsLarge" style="text-align:center">Invalid Validation String and/or Case ID</div>
<br>
We apologize, but the validation string and/or case id that were submitted do not match our database records.
<br><br>
Please contact our office at 973-514-2002 or <a href="mailto:info@college-retirement.com">info@college-retirement.com</a> to let us know about this error.
<br><br>
Please reference validation string <b><?php echo $_GET["random"]; ?></b> and case id <b><?php echo $_GET["id"]; ?></b>.
</div>
