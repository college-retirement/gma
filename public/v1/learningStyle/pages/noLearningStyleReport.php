...
if ($missing=="1")
	echo "No answers submitted for Learning Style!";
else if ($missing=="2")
	echo "No answers submitted for Brain Hemisphere!";
else
	echo "No answers submitted for Learning Style or Brain Hemisphere!";
?>
</div>
