...
///////////from here onwords code is added for no email-id provided
            ...
            else
            {
                ...
                {
                    //ListBox2.Items.Add(s);
                    int last11 = s.LastIndexOf("(");
                    string s11 = s.Remove(last11);
                    string path = Server.MapPath("./uploads/" + s11);
                    msg.Attachments.Add(new Attachment(path));
                }
                ...
                {
                    lblMessage.Text = "There is no Body with Appointment, So first Add Body for Appointment.";
                    return;
                }
                msg.IsBodyHtml = true;
                msg.Body = body;
