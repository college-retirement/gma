    ...
    private void scheduleAppointment(object obj, EventArgs args)
    {
        ...
        try
        {
            ...
            if (Session["clientemail"].ToString().Trim() == "")
            {
                ...
                sconn.Open();
                SqlCommand sc = new SqlCommand("select sbodytext from SBody where sbodynum = 'Sbody22' ", sconn);
...
//////////AVINASH PAWAR/from here onwords code is added for no email-id provided
            ...
            else
            {
                ...
                string str_body = "Select sbodytext from sbody where sbodynum = 'Sbody16'";
