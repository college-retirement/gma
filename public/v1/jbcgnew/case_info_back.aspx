...
<html>
  <head>
	...
	public void Page_Load() {
        ...
        SqlConnection sqlconnect1 = new SqlConnection(config);
        sqlconnect1.Open();
		if(!Page.IsPostBack) {
			Session["cancel"] = "";
			Session["view"] = "three";
            ...
            SqlDataAdapter dad = new SqlDataAdapter("select * from madison_sysdba.locations", sqlconnect1);
            dad.Fill(ds_sbody);
            DropDownList1.DataTextField = "name";
            DropDownList1.DataValueField = "id";
            DropDownList1.DataSource = ds_sbody.Tables[0];
	...
	private void scheduleAppointment(Object obj, EventArgs args) {
		...
		try {
            ...
            string config1 = ConfigurationManager.ConnectionStrings["madison_collegeadvisorsnetworkConnectionString2"].ConnectionString.ToString();
            SqlConnection sqlconnect1 = new SqlConnection(config1);
            sqlconnect1.Open();
            string sqlquery;
            sqlquery = "select id from madison_sysdba.locations where madison_sysdba.locations.name='"+DropDownList1.SelectedItem.Text.ToString()+"'";
            SqlCommand scmd = new SqlCommand(sqlquery, sqlconnect1);
            ...
            dr.Close();
			string sql = "INSERT INTO madison_sysdba.appointments(claimid,userid,appointment,locationid,status,pending) VALUES('" + Session["id"] + "','" + Session["userid"] + "','" + t + "'," + id + ",'Y','1');";
			getMssqlData(sql);
			...
			sql = "UPDATE " + Session["mainDataTable"] + " SET nextApptDate = '" + t + "', nextApptLocationid = " + id + " WHERE [id] = " + Session["id"];
			getMssqlData(sql);
...
<tr>
	...
	<td align="center">
		...
		%>
		<table border="0" cellpadding="2" cellspacing="2" align="center" valign="top" style="width: 99%">
		<tr>
		...
		<% }else if(Session["state"].ToString() == "new") { %>
			<tr>
				<td colspan="2" align="center" style="height: 24px"><font class="black">Schedule Appointment</font></td>
			</tr>
			<tr>
				<td colspan="2" align="center" style="height: 117px">

				<table border="0" cellpadding="4" cellspacing="0" align="center" style="width: 78%">	
				<tr>
				...
				<tr>
					...
					<td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DropDownList1"
                            ErrorMessage="Please select the location" Font-Bold="False" Font-Names="verdana"
                            Font-Size="9pt" InitialValue="Select location" Width="192px"></asp:RequiredFieldValidator></td>
				</tr>
				<tr>
