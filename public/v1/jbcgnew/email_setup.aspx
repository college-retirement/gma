    ...
    protected void btnSendMail_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            sconnect.Open();
                ...
                string str1 = "Select * from Users where emailaddress = '" + TxtTo.Text.Trim() + "'";
...
<%
    ...
    <div style="text-align:center;">
        ...
        <div>
            <asp:Button ID="lnkMail" CausesValidation="False" Text="Send an E-mail" runat="server" OnClick="lnkMail_Click" PostBackUrl="~/jbcgnew/email_setup.aspx"></asp:Button>
            <asp:Button ID="lnkAdd" CausesValidation="False" Text="Add a Template" runat="server" OnClick="lnkAdd_Click" PostBackUrl="~/jbcgnew/email_setup.aspx" ></asp:Button>
            <asp:Button ID="lnkEdit" CausesValidation="False" Text="Edit a Template" runat="server" OnClick="lnkEdit_Click" PostBackUrl="~/jbcgnew/email_setup.aspx"></asp:Button>
            <asp:Button ID="lnkDelete" Text="Delete a Template" CausesValidation="False" runat="server" OnClick="lnkDelete_Click" PostBackUrl="~/jbcgnew/email_setup.aspx"></asp:Button>
        ...
        <asp:Panel ID="pnlEmail" runat="server" Height="50px" Style="position: static" Width="650px">
            ...
            <asp:Label ID="Label1" runat="server" Height="30px" Style="text-align:center;" Text="             Send an Email Template"
            ...
            <tr>
             ...
             <td style="width: 400px;text-align:left;">
                    <asp:TextBox ID="TxtSub" runat="server" Style="text-align:left;" Width="314px"></asp:TextBox></td>       
            </tr>
            <tr>
                ...
                <asp:DropDownList ID="ddlSbody" runat="Server" Width="322px" AutoPostBack="True" OnSelectedIndexChanged="ddlSbody_SelectedIndexChanged" >
                </asp:DropDownList>
            ...
            <tr>
               ...
               <asp:TextBox ID="Txtbody" runat="server" Style="text-align:left;" TextMode="MultiLine" Height="234px" Width="314px"></asp:TextBox></td>
            </tr>
       <%-- <tr>
        ...
        <tr>
           ...
           <asp:Label ID="Label6" runat="server" Height="23px" Style="text-align:right;" Text="Attachments : "
            ...
            <td style="text-align:left; width: 400px;">
                <asp:ListBox ID="ListBox1" runat="server" Style="position: static" Width="216px" Height="120px"></asp:ListBox><%--<br />
                Total File size : 
...
<tr>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp;<span style="font-size: 14pt"><strong>Add a Template</strong></span></tr>
                ...
                <tr style="text-align:left;width:400px;">
                    <td style="text-align:right; width: 136px;"><asp:Label ID="Label8" runat="Server" Text="Enter Sbody Name :" Height="26px" Width="130px"></asp:Label>
                    </td>
                    <td ><asp:Label ID="lbl_msg" runat="Server" Text="BodyText" Width="64px"></asp:Label>
                    <asp:TextBox ID="txtid" runat="server" Width="228px" Text="" style="position: static"></asp:TextBox>&nbsp;
                    </td>
            ...
            <tr style="text-align:left;width:400px;">
                <td style="vertical-align:top;text-align:right; width: 136px;"><asp:Label ID="Label9" runat="Server" Text="Enter Body Text :"></asp:Label>
                </td>
                <td colspan="1">
                <asp:TextBox ID="txtsbody" runat="server" Width="300px" Text="" TextMode="MultiLine" Height="257px"></asp:TextBox>
...
<tr>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp;<span style="font-size: 14pt"><strong>Edit a Template</strong></span></tr>
                <tr style="text-align:left;width:400px;">
                    <td style="text-align:right; width: 127px;">
                    <asp:Label ID="Label10" runat="Server" Text="Select Sbody Name :" Width="199px"></asp:Label>
                    </td>
                    <td style="text-align:left;">
                        <asp:DropDownList ID="DDLedit" runat="server" Width="276px" OnSelectedIndexChanged="DDLedit_SelectedIndexChanged" AutoPostBack="True" >
                            </asp:DropDownList>
             ...
             <td style="vertical-align: top; width: 127px; text-align: right">
               ...
               <td style="height: 24px; width: 400px;text-align:left;">
                   ...
                   <asp:Button ID="btnSendFile" runat="server" Style="position: static" Text="Upload File" OnClick="btnSendFile_Click" Height="20px" /></td>         
                      ...
                      <tr>
           <td style="width: 127px;vertical-align:top; height: 24px;text-align:right;">
           <asp:Label ID="Label16" runat="server" Height="23px" Style="text-align:right;" Text="Attachments :"
               Width="195px"></asp:Label></td>
            <td style="text-align:left; width: 400px;">
                <asp:ListBox ID="ListBox3" runat="server" Style="position: static" Width="272px" Height="120px"></asp:ListBox>
                <asp:Button ID="btnRemoveFile" runat="server" OnClick="btnRemoveFile_Click" Style="position: static"
                    Text="Remove File" Height="20px" Width="80px" /></td>
        </tr>
           
            <tr style="text-align:left;width:400px;">
                <td style="vertical-align:top;text-align:right; height: 159px; width: 127px;"><asp:Label ID="Label12" runat="Server" Text="Enter Body Text :" Width="193px"></asp:Label>
                </td>
                <td colspan="1" style="height: 159px"><asp:TextBox ID="Txtsbody1" runat="server" Width="350px" Text="" TextMode="MultiLine" Height="241px" CausesValidation="True"></asp:TextBox>&nbsp;
                </td>
            </tr>
             <tr> <td colspan="2"></td>  </tr> 
            <tr style="text-align:center;width:400px;">
...
<tr>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp;<span style="font-size: 14pt"><strong>Delete a Template</strong></span></tr>
                <tr style="text-align:left;width:400px;">
                    ...
                    <td style="width: 449px" >
                        <asp:DropDownList ID="DDLdelete" runat="server" Width="308px" OnSelectedIndexChanged="DDLdelete_SelectedIndexChanged" AutoPostBack="True" >
                            </asp:DropDownList><asp:RequiredFieldValidator ID="rfvDDLdelete" ControlToValidate="DDLdelete" runat="server" ErrorMessage="Select the Sbody to Delete" InitialValue="Select Sbody"></asp:RequiredFieldValidator>  
                    </td>
               ...
               <tr style="width: 400px; text-align: left">
                   ...
                   <td style="width: 449px;vertical-align:top;text-align:left;">
                       <asp:TextBox ID="TextBox2" runat="server" Height="186px" Style="text-align: left"
                           TextMode="MultiLine" Width="302px" ReadOnly="True"></asp:TextBox></td>
               </tr>
                <tr style="width: 400px; text-align: left">
