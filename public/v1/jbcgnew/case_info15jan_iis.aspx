...
<script runat="server">
    ...
    private void scheduleAppointment(object obj, EventArgs args)
    {
        ...
        try
        {
            ...
            //getMssqlData(sql);//////////this commented by me avinash
            ...
            if (Session["clientemail"].ToString().Trim() == "")
            {
                ...
                //string htmlstart = "<html><body>";commented by avinash
                //string htmlend = "</body></html>";commented by avinash
                sconn.Open();
                SqlCommand sc = new SqlCommand("select sbodytext from SBody where sbodynum = 'BodyTextAppointmentNoEmail' ", sconn);
                ...
                if (str_b.Contains("##datetime##"))
                {
                    str_b = str_b.Replace("##datetime##", t);
                }
...
//////////AVINASH PAWAR/from here onwords code is added for no email-id provided
                msg.IsBodyHtml = true;
                msg.Body = str_b;
                //msg.Body = body;
            ...
            else
            {
                ...
                string str_body = "Select sbodytext from sbody where sbodynum = 'BodyTextAppointmentEmail'";
    ...
    private void updateDB(object obj, EventArgs args)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                //getMssqlData(sql);          //avinash coomented
                Session["cancel"] = "";
            }
        }
        catch (Exception ex) 
