	...
	private void addLead(Object obj, EventArgs args) {
		...
		if(message.Text == "") {
			try {
	            ...
	            {
	                message.Text += "<br />*Error Creating Account!*<br />" + myExc.Message;
	            }
	            
	            if (Request["TYL"].ToString() == "Yes")
	            {
	                try
	                {
	                    EventManager.Trigger("newefcalead",id.ToString());
	                }
	                catch(Exception myExc2)
	                {
	                    message.Text += "<br />*Error Triggering Events!*<br />" + myExc2.Message;
	                }
	            }
			}catch(Exception e){
