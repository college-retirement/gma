...
<img src="<%= Session["imagedir"] %>tabs_end.gif" width="26" height="23"><img src="<%= Session["imagedir"] %>tabs_divider.gif" width="1" height="23"><A 
	HREF="case_info.aspx" target="_top" onMouseOver="swapImage('but1', '<%= Session["imagedir"] %>case_review_menu/but1on.gif');" onMouseOut="swapImage('but1', '<%= Session["imagedir"] %>case_review_menu/but1off.gif');"><IMG SRC="<%= Session["imagedir"] %>case_review_menu/but1off.gif" ALT="But1 Caption" BORDER="0" NAME="but1" height="23"></a><img src="<%= Session["imagedir"] %>tabs_divider.gif" width="1" height="23"><A 
	...
	HREF="clientInfoUpload.aspx" target="_top" onMouseOver="swapImage('but7', '<%= Session["imagedir"] %>case_review_menu/but7on.gif');" onMouseOut="swapImage('but7', '<%= Session["imagedir"] %>case_review_menu/but7on.gif');"><IMG SRC="<%= Session["imagedir"] %>case_review_menu/but7on.gif" ALT="But7 Caption" BORDER="0" NAME="but7" height="23"></a><img src="<%= Session["imagedir"] %>tabs_divider.gif" width="1" height="23"><A
