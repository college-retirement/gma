            ...
            <td style="text-align: left; font-size: 8pt; font-family: Calibri, Verdana;" valign="top">
                <table style="width: 100%; height: 8in">
					<tr>
						...
						<br><br>
						This service package includes on-going assistance of our professional staff - this assistance will be available until your student graduates High School. You will be provided the support necessary to accomplish all of the steps that you and your student will need to take throughout the admission process.<br><br>
						</td>
					</tr>
                    <tr>
                        <td valign="top">
                        ...
                        <td valign="top">
                            ...
                            <p>
                                <strong>How Do We Use Your Personal Information?
                                    <br />
                                </strong>We may use your personal information and may provide it to others such as your planner, any 3rd party companies and firms providing services on our behalf (such as Student Aid Services, FAFSA.com, eprep and another other company).
                                <ul>
                            ...
                            <p>
                                ...
                                <br />
                                <br />
                                We will not disclose any medical or health information we collect about you unless authorized by you to do so or permitted by law.  We may share such information without authorization, to the extent permitted by law, with third parties or affiliates assisting us, such as those who assist us in performing our obligations.</p>
                            <p>
                ...
                <table style="width: 100%; height: 8.5in">
                    <tr>
                        <td valign="top">
                                ...
                                These college services are not designed for, nor should they be relied upon as a 
                                ...
                                participant in fulfilling his or her college services objectives. In addition, 
                            ...
                            Any personal information provided may be shared between College and Retirement Solutions, LLC solely for the purpose of understanding the family’s situation in detail.  College and Retirement Solutions will not disclose any information to parties not mentioned in this agreement.<br/><br/> 
                                We will record all client meetings and take handwritten notes to insure that all concerns and comments are duly noted.  Information will be shared with all support staff, third party provides, and anyone deemed by College and Retirement Solutions, LLC as an integral participant in fulfilling the obligations of services purchased.
                ...
                <table cellpadding="0" cellspacing="15" border="0" style="width:100%; font-family:Calibri;">
                    <tr>
                        ...
                        <td style="width: 90%; vertical-align:top;">
                            By initialing and signing below, you agree that you would like to have a discussion regarding your personal finances  and to assess if there are any issues as they relate to your family’s future goals, including debt management, retirement, college funding, risk management, and any other possible concern that may arise out of a review of your circumstances.</td>
                    </tr>
                    <tr>
                        <td style="width: 10%; vertical-align:top;">
                            <table>
                        ...
                        <td style="width: 90%; vertical-align:top;">
                            It is understood if any re-aligning of assets or purchase of financial Products  is done through Nancy Ziering (Insurance Agency) then a commission may be earned.  It is also understood that any suggestions made to alter your family financial circumstances can be done so through any representative of your choosing.
</td>
                    </tr>
                    <tr>
                        <td style="width: 10%; vertical-align:top;">
                            ...
                            <table border="0" cellpadding="5" cellspacing="0" style="width: 100%">
                                ...
                                <tr>
                                    <td class="PAitem" style="text-align: left">
                                        ...
                                        <asp:DataList ID="DataList2" runat="server" RepeatColumns="2" RepeatDirection="Horizontal"
                                            ...
                                            <FooterTemplate>
                                                <span style="font-size: 8pt">Please Note: All monthly installments will be subject to
                                                    an additional monthly service charge of $2.50.</span>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                ...
                                <tr>
                                    <td class="PAitem">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" style="border-bottom: black 1px solid" valign="bottom">
                                                    <asp:TextBox ID="TextBox10" runat="server" BorderWidth="0px" Width="95%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 49%; border-bottom: black 1px solid" valign="bottom">
                                                    <asp:TextBox ID="TextBox11" runat="server" BorderWidth="0px" Width="95%"></asp:TextBox>
                                                </td>
                                                <td align="right" nowrap="nowrap" style="width: 1%" valign="bottom">
                                                    <br />
                                                    Card Type:
                                        ...
                                        I hereby authorize College &amp; Retirement Solutions to charge my credit card fees
                                        for services in the amount and description of the payment plan described above.<table
