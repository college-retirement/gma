...
<html>
  <head>
	...
	public void Page_Load() {
		...
		Session["sql"] = "SELECT d.[id] AS [ID], d.col0004 + ',' + d.col0002 AS [Student Name], d.col0018 AS [High School], d.col0013 AS [Home Phone], d.status + ' ' + cast(month(d.transactionDate) AS varchar) + '-' + cast(day(d.transactionDate) AS varchar) + '-' + cast(year(d.transactionDate) AS varchar) AS [Status] FROM " + Session["mainDataTable"] + " AS d ";
	...
	private void deleteFirst(Object sender, DataGridCommandEventArgs e) {
		...
		sql = Session["sql"] + " WHERE [id] = " + Session["id"] + " ORDER BY [" + Session["col"] + "] " + Session["sort"];	
...
<!--#include file="./images/admin_menu/nav5.aspx"-->
