...
<tr>
	...
	<tr>
		...
		<td align="center">
			<font class="black">
			<form name="frmCollegeChoice" method="POST" action="../collegeChoice/pages/collegeChoiceValidate.php" target="_blank"><a class="black" href="javascript:document.frmCollegeChoice.submit();">CollegeChoice</a><br>
			<input type="hidden" name="txtUsername" id="txtUsername" value="<%= Session["username"].ToString() %>">
			<input type="hidden" name="crs" id="crs" value="true">
			</form>
			</font>
		</td>
		<td align="center">
