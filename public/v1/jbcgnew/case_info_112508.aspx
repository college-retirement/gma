...
<script runat="server">
    ...
    public void Page_Load()
    {
        ...
        GridView1.DataBind();
        DataTable myNotes = SQLManager.GetData("convert(varchar(10),n.createdDate,101) as [Date], u.name as [Name], n.note as [Note]","notes n LEFT OUTER JOIN users u ON n.createdBy=u.userid","WHERE n.claimid='" + Session["id"].ToString() + "' AND n.note <> '' order by n.id desc");
...
*/        }
    ...
    public string DFView(string myID)
    {
        ...
        if (forms == null || forms == string.Empty || forms.ToUpper() == "N")
            return "No";
        else return "<a href=\"../viewDataForm.aspx?ID=" + myID + "\" target=\"_blank\">View</a>";
    }        
                ...
                <table border="0" cellpadding="5" cellspacing="0" style="width: 100%">
                    <tr>
                        <td align="center" width="25%">
                            <font class="black">
                            Case ID:
                            <asp:Label ID="caseidlabel" runat="server"></asp:Label></font></td>
                        <td align="center" width="25%">
		...
		if(Session["state"].ToString() == "list") { %>
			...
			<tr class="grey">
				...
				<tr bgcolor="#4A3C8C">
                    ...
                    <td>
                        <strong><span style="font-size: 9pt; color: #ffffff; font-family: Arial">Forms?</span></strong></td>
					<td>&nbsp;</td>
				</tr>
				<tr bgcolor="#E7E7FF">
                        ...
                        <tr>
                            <td width="65%" valign="top">
                                <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="Black"
                                    ...
                                    <ItemStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" HorizontalAlign="Right" VerticalAlign="Top" Width="1%" />
                                    <SelectedItemStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
                                    <HeaderTemplate>
                                        Notes</td><td style="background-color: #4A3C8C;">&nbsp;
                                    </HeaderTemplate>
                                    <HeaderStyle BackColor="#4A3C8C" Font-Bold="True" ForeColor="#F7F7F7" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("Date") %>'></asp:Label><br />
                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("Name") %>'></asp:Label>
                                        </td>
                                        <td align="left" valign="top" style="border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid; background-color: #fff">
