...
$studentMinority=$_POST["lstStudentMinority"];

$_SESSION["studentminority"]=$studentMinority;
...
if ($echoToScreen) echo "Parents' Total Income=$parentsTotalIncome<br>";
...
if ($echoToScreen) echo "Parents' Total Allowances=$parentsTotalAllowances<br>";

//calculate parents' available income
$parentsAvailableIncome=$parentsTotalIncome-$parentsTotalAllowances;

if ($echoToScreen) echo "Parents' Available Income=$parentsAvailableIncome<br>";
...
if ($echoToScreen) echo "Parents' Contribution From Assets=$parentsContributionFromAssets<br>";
...
//echo $parentsContribution . " --- ";

if ($parentsContribution<0)
	$parentsContribution=0;

if ($echoToScreen) echo "Parents' Contribution=$parentsContribution<br><br>";
...
if ($echoToScreen) echo "Student Total Income=$studentTotalIncome<br>";
...
if ($echoToScreen) echo "Student Total Allowances=$studentTotalAllowances<br>";
...
if ($echoToScreen) echo "Student Contribution From Available Income=$studentContributionFromAvailableIncome<br>";
...
if ($echoToScreen) echo "Student Contribution From Assets=$studentContributionFromAssets<br><br>";

$efcFm=round($parentsContribution + $studentContributionFromAvailableIncome + $studentContributionFromAssets);

/*
echo $parentsContribution . " --- ";
echo $studentContributionFromAvailableIncome . " --- ";
echo $studentContributionFromAssets . " --- ";
*/

//calculate IM EFC
$efcIm=$efcFm+($studentContributionFromAvailableIncome<0 ? 1750 : $studentContributionFromAvailableIncome+1750)+round(($parentsHomeCurrentMarketValue-($parentsFirstMortgage+$parentsSecondMortgage+$parentsHomeEquityLineOfCredit))*.0564);
...
if ($echoToScreen) echo "FM EFC=$efcFm<br>IM EFC=$efcIm<br>IM EFC for appeals=$efcImAppeals<br><br>";

$_SESSION["efcfm"]=$efcFm;
$_SESSION["efcim"]=$efcIm;

if ($echoToScreen) echo "<a href=\"collegeChoiceStudentDataForm.php\">continue</a>";

if (!$echoToScreen) header("location:collegeChoiceStudentDataForm.php");
