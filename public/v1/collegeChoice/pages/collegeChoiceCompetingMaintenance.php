...
<table width="100%" border="0">
	<tr>
		...
		<td align="left" valign="top" nowrap>&nbsp;&nbsp;CollegeBoard ID<br>&nbsp;&nbsp;<input type="text" name="txtCollegeBoardId" size="5" maxlength="5" style="background-color:grey;" value="<?php echo $collegeBoardId; ?>" readonly></td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="2">Web Site<br><input type="text" name="txtWebSite" size="75" maxlength="500" value="<?php echo $webSite; ?>"></td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="2">Request More Information Link<br><input type="text" name="txtRequestInfo" size="75" maxlength="500" value="<?php echo $requestInfo; ?>"></td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="2">Apply Online Link<br><input type="text" name="txtApplyOnline" size="75" maxlength="500" value="<?php echo $applyOnline; ?>"></td>
	</tr>
</table>
